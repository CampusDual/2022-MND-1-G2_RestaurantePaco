...
//
//		Comanda comandaOne = new Contact(1, "One", "Surname1One", "Surname2One", 666555444, "contact-one@gmail.com");
...
//		when(this.comandaRepository.findAll(any(SpecificationImpl.class), isA(Pageable.class))).thenReturn(comanda);
//
//		// test
//		List<ComandaDTO> empList = comandaService.getComandas(pageFilter).getData();
//
...
//
//	@Test
//	void comandaNotPresentInDb() {
//		when(comandaRepository.findById(1)).thenReturn(Optional.empty());
//		assertNull(comandaService.getComanda(1));
//
//	}
//
//	@Test
